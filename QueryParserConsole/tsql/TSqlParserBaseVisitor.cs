...
public partial class TSqlParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ITSqlParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="TSqlParser.go_batch_statement"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitGo_batch_statement([NotNull] TSqlParser.Go_batch_statementContext context) { return VisitChildren(context); }
